...
class Norm(models.Model):
    ...
    default_detection = models.BooleanField(default=False)
    default_protection = models.BooleanField(default=False)
    default_human_safety = models.BooleanField(default=False)  # Used as default in templates
